<!-- Modal -->
<div class="modal fade modal-xl" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="row mt-2">
                    <div class="col-12 alg-bg-dark rounded-4">
                        <div class="row d-flex justify-content-around align-items-center text-white p-2">
                            ...
                            <div class="col-3 d-flex gap-5 alg-text-h3">
                                <span>LKR 2300</span>
