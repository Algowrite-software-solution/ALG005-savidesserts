...
<body>
                        ...
                        <form>
                            ...
                            <div class="text-center">
                                <button type="button" class="btn text-primary" data-bs-toggle="modal"
                                    data-bs-target="#ALG-forgotPassword-Modal">
    ...
    <div class="modal fade" id="ALG-forgotPassword-Modal" tabindex="-1" aria-labelledby="ALG-forgotPassword-Modal-Label"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body ALG-main-model">
                    ...
                    <div class="ALG-main-model2 p-3 rounded-5">
                        ...
                        <form>
                            <!-- Email input -->
                            <div class="form-outline mb-4">
                                <input type="email" id="#" class="ALG-model-input form-control rounded-5"
                                    placeholder="Email address" />
                            ...
                            <div class="d-flex justify-content-center align-items-center ">
                                <button type="submit"
                                    class="p-2 mb-4 w-100 rounded-5 ALG-model-button text-white fw-bolder">Reset
                                    Password</button>
                            </div>
