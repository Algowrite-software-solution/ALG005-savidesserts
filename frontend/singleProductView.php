                    ...
                    <div class="col-lg-5 col-12 d-flex flex-column order-1 order-lg-2">
                        <div
                            ...
                            <p class="px-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat,
                                ...
                                nemo iste?</p>
                            <div
                                class="col-lg-4 d-flex my-3 text-white p-2 px-2 ALG-singleProduct-tag justify-content-around align-items-center rounded-5">
                                <div>RATING</div>
                                    ...
                                    for ($x = 0; $x < 3; $x++) {
                                        ...
                                        <div class="col-5 col-md-6 col-lg-4 d-flex justify-content-center mx-auto">
                                            <div class="d-flex flex-column justify-content-end">
                                                ...
                                                <div> <img src="resources/images/item1.png" alt=""
                                                        class="im position-relative pt-4"
                                                        style="width:222.3px; height:320px;"></div>

                                                <div class="mx-4 position-absolute mt-3" style="width:176.6px;">
                                                    <div class="px-1 m-0 alg-bg-tan p-2  rounded-1">
                                                        <div class="d-flex justify-content-between pb-1">
                                                            <span class="text-white fw-bold alg-text-h3">Product
                                                                Title</span>
                                                            <span class="fw-bold alg-text-h3">LKR 1300</span>
                                                        </div>

                                                        <div>
                                                            <p class="alg-text-h3 lh-1 pb-1 my-0 text-white">This is the
                                                                product description and it contain small details.</p>
                                                        </div>
