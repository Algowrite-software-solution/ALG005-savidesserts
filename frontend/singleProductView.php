                ...
                <div class="flex-column flex-lg-row col-12 d-flex justify-content-center align-items-center mt-5 mb-5">
                    ...
                    <div class="col-lg-5 col-12 d-flex flex-column order-1 order-lg-2">
                        <div class="col-12 d-flex flex-column justify-content-center justify-content-lg-start align-items-center align-items-lg-start mb-5">
                            ...
                            <div class="col-lg-2 my-3 ALG-singleProduct-tag text-white text-center rounded-5">Category
                            </div>
                            <p class="px-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat,
                                molestias ipsa
                                similique
                                sed
