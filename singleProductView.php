        ...
        <div class="col-12">
            ...
            <div class="col-12 d-flex singleProduct-main">
                ...
                <div class="flex-column flex-lg-row col-12 d-flex justify-content-center align-items-center mt-5 mb-5">
                    ...
                    <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column pt-4 pb-4 mx-5 mt-lg-0 mt-3 rounded-5 justify-content-center align-items-center singleProductImg-box">
                        <div class="col-11">
                            <div class="container ">
