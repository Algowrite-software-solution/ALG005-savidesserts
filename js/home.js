    ...
    .then((data) => {
      ...
      if (data.status === "success") {
        ...
        data.results.forEach((element) => {
          ...
          <div class="col-12 col-md-2 col-lg-2 d-flex justify-content-end overflow-hidden flex-column ld-bs-card w-100" style="background: url(${element.image}); height:300px">
