...
<body class="scrollbar w-100" style="overflow-x: hidden;">
                        ...
                        <div class="col-12 col-lg-8">
                            ...
                            <div class="row mx-4 mx-0">
                                <div
                                    ...
                                    <button
                                        class="alg-bg-gold alg-button-hover p-2 rounded-4 text-white fw-bold alg-text-h2">ORDER
                                        NOW</button>
                                </div>
                            </div>
                        </div>
    ...
    <section>
        <div
            class="col-12 d-flex flex-column justify-content-center align-items-center testm-main w-100 pt-3 alg-bg-dark px-5">
            <span class="alg-text-h2 text-white fw-bold">TESTAMONIALS</span>
            <div class="col-12 d-flex flex-lg-row flex-column justify-content-center align-items-center m-4 ">
                <div class="testm-card d-flex justify-content-center align-items-center m-3 alg-bg-light">
                    <div class="d-flex testm-card-img-div p-2 justify-content-center align-items-center"><img
                            src="https://javainstitute.edu.lk/img/faculty/dr-ishantha.jpg"
                            class="img-fluid testm-card-img ">
                    </div>
                    <div class="pt-3">
                        <p class="card-para alg-text-dark fw-bold">"Pure nostalgia in every bite!
                            [Your Dessert Brand Name] captures
                            the essence of Sri Lankan sweets
                            perfectly. Each dessert is a journey
                            back to my childhood, filled with
                            warmth and flavour. Absolutely love
                            it!"
                        </p>
