                    ...
                    <div class="row d-felx flex-column flex-md-row justify-content-center align-items-center gap-5">
                        <div class="col-10 col-md-5">
                            <div class="text-center d-flex justify-content-center">
                                <iframe
                                    ...
                                    width="500" height="250" class="alg-contct-map" allowfullscreen="" loading="lazy"
                        ...
                        <div class="col-12 col-md-5 d-flex flex-column gap-4">
                            <div class="row d-flex justify-content-center cursor">
                                <div class="col-10">
                                    <div
                                        class="bg-white p-2 d-flex align-items-center gap-5 px-3 alg-div-hover alg-contct-info-box">
                            ...
                            <div class="row">
                                <div class="row d-flex justify-content-center">
                                    <div
                                        ...
                                        <span><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34"
                                                viewBox="0 0 24 24">
                                                <path
